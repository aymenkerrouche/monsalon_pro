    ...
    return Consumer<AuthProvider>(
        builder: (context, auth, child) {
          return ExpansionTile(
            title: Text(widget.day,style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w700),),
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: "00:00",
                          hintStyle: TextStyle(fontWeight: FontWeight.w600,color: primary,fontSize: 18),
